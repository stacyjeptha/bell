...
exports.v2 = function (settings) {
    ...
    return function (request, reply) {
        ...
        if (!request.query.code) {
            ...
            query.redirect_uri = query.redirect_uri || request.server.location(request.path, request);
            query.state = nonce;
        ...
        var query = {
            ...
            redirect_uri: settings.providerParams.redirect_uri || request.server.location(request.path, request)
        };
